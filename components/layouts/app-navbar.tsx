      ...
      <div className="flex items-center justify-between md:justify-end w-full md:w-auto gap-4 md:gap-6" ref={menuRef}>
        ...
        <div className="flex items-center gap-3 md:gap-5">
            ...
            {activeMenu === "notifications" && (
              <div className="absolute right-0 mt-3 w-64 md:w-80 bg-white rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.1)] border border-gray-100 py-3 animate-in fade-in zoom-in duration-200">
                ...
                <div className="max-h-[300px] overflow-y-auto">
                  <div className="px-4 py-3 hover:bg-[#F5F7FA] cursor-pointer transition-colors border-b border-gray-50 last:border-0 text-left">
                  ...
                  <div className="px-4 py-3 hover:bg-[#F5F7FA] cursor-pointer transition-colors border-b border-gray-50 last:border-0 text-left">
                    <p className="text-[10px] text-[#718EBF] mb-1">1 hour ago</p>
                    <p className="text-sm text-[#343C6A] font-medium leading-snug">New login detected from Chrome on Mac.</p>
                  </div>
                </div>
              </div>
            )}
          ...
          <div className="relative">
            ...
            {activeMenu === "profile" && (
              <div className="absolute right-0 mt-3 w-56 bg-white rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.1)] border border-gray-100 py-2 animate-in fade-in zoom-in duration-200 text-left">
                <div className="px-4 py-2 border-b border-gray-50 mb-1">
                  <p className="text-sm font-bold text-[#343C6A]">Charlene Reed</p>
                  <p className="text-[11px] text-[#718EBF]">Premium Member</p>
                </div>
                <Link href="/profile" className="w-full px-4 py-2.5 text-left text-sm text-[#343C6A] hover:bg-[#F5F7FA] flex items-center gap-3 transition-colors">
